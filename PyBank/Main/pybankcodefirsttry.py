...
# with open(pybank_csv, 'w') as text:
#         text.write("Financial Analysis")
#         text.write("-------------------")
#         text.write("Total: $" + str(total_net))
#         text.write("Average Change: " + str(average_change))
#         text.write("Greatest Increase: " + str(greatest_increase))
#         text.write("Greatest Decrease: " + str(greatest_decrease))